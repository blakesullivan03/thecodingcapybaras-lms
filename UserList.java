...
public class UserList {
    ...
    /**
     * Checks if a user with the given email already exists in the list of users.
...
*/
    ...
    /**
     * Retrieves a User object based on its username.
     ...
     * @return the User object corresponding to the given email and password, or null if no such User exists
     * */
